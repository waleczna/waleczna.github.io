$(document).ready(function() {
  const apiRoot = 'waleczna-tasks-prod-sunnybeautifuldays-vxk1u1.mo6.mogenius.io:80/v1/tasks';
  const trelloApiRoot = 'waleczna-tasks-prod-sunnybeautifuldays-vxk1u1.mo6.mogenius.io:80/v1/trello';
